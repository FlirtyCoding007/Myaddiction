 ...
 let canvas = document.getElementById('stage');
  ...
  if(value=="muddu"){
    console.log("User entered muddu");
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/pic1.jpg`;
  ...
  if(value=="putti"){
    ...
    console.log("User entered prashi");
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/pic2.jpg`;
    const hoverUrl = "images/love.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
  ...
  if(value=="nan muddu"){
    console.log("User entered nan muddu");
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/pic3.jpg`;
    const hoverUrl = "images/love.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
  ...
  if(value=="cutie"){
    console.log("User entered cutie");
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/pic4.jpg`;
    const hoverUrl = "images/love.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
  ...
  if(value=="stupid"){
    console.log("User entered stupid");
    const myImage = document.getElementById("myImage");
    const imageUrl = `images/pic5.jpg`;
    const hoverUrl = "images/pic05.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
    canvas.style.display="";
